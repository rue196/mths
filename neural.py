...
def generate_spectral_dataset(num_samples=200, K_min=10, K_max=60, N_harmonics=20):
...
def main():
    ...
    X, y = generate_spectral_dataset(num_samples=500, K_min=10, K_max=60, N_harmonics=30)
